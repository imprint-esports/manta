...
func file_connectionless_netmessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_connectionless_netmessages_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_connectionless_netmessages_proto_msgTypes[1].Exporter = func(v any, i int) any {
